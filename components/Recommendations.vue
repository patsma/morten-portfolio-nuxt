<template>
  <section class="component component--accordion grid h-full py-14" id="component-accordion">
    <div class="col-span-12 col-start-1 col-end-13 grid grid-cols-12">
      <div class="col-start-2 col-end-12 grid gap-10">
        <div class="accordion grid">
          <div class="accordion__title ibmplex-500 text-dark-40 text-animation-2 grid pb-[40px] text-base">Recommendations</div>
          <div class="accordion__items fade-in-animation grid min-w-[150vw] md:min-w-[350vw]">
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Bærnholdt</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Elmqvist</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Geisler Hansen</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Krøis Damsted</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Rosener</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">Bromer Jægersdorf</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  ...
                  <span class="peiko-100">McNally</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                ...
                <div class="accordion__item-name text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                  <span class="ibmplex-200">Thomas</span>
                  <span class="peiko-100">Pries</span>
                </div>
              </div>
            </div>
            <div class="hoverable accordion__item relative grid grid-flow-col justify-between py-8" data-hover-text="Open">
              ...
              <div class="accordion__item-wrapper grid grid-flow-col content-center items-center justify-start gap-12">
                <div class="accordion__item-title peiko-italic-100 text-xl leading-[120%] md:text-8xl md:tracking-tighter">
                ...
                <div class="accordion__item-name text-xl leading-[120%] tracking-tighter md:text-8xl">
                  ...
                  <span class="peiko-100">Cytryn</span>
                </div>
              </div>
            </div>
          </div>
