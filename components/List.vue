          ...
          <div class="list__items fade-in-animation grid">
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-title-wrapper relative z-20 grid grid-flow-col justify-start gap-4">
                ...
                <div class="list__item-title-excerpt text-dark-40 ibmplex-500 self-center uppercase">Intranet</div>
              </div>
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-category text-dark-40 ibmplex-400 relative z-20 self-center text-base">Art direction, Interactive design & UI</div>
            </div>
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-title-wrapper relative z-20 grid grid-flow-col justify-start gap-4">
                ...
                <div class="list__item-title-excerpt text-dark-40 ibmplex-500 self-center uppercase">Redesign</div>
              </div>
              <div class="list__item-category text-dark-40 ibmplex-400 relative z-20 self-center text-base">Art direction, Interactive design, & UI</div>
            </div>
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-category text-dark-40 ibmplex-400 relative z-20 self-center text-base">Interactive design & UI</div>
            </div>
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-title-wrapper relative z-20 grid grid-flow-col justify-start gap-4">
                ...
                <div class="list__item-title-excerpt text-dark-40 ibmplex-500 self-center uppercase">Print digitalisation</div>
              </div>
              <div class="list__item-category text-dark-40 ibmplex-400 relative z-20 self-center text-base">Art direction, Interactive design & UI</div>
            </div>
            ...
            <div class="list__item relative grid justify-between py-8 md:grid-flow-col">
              ...
              <div class="list__item-title-wrapper relative z-20 grid grid-flow-col justify-start gap-4">
                ...
                <div class="list__item-title-excerpt text-dark-40 ibmplex-500 self-center uppercase">In-store</div>
              </div>
              <div class="list__item-category text-dark-40 ibmplex-400 relative z-20 self-center text-base">Art Direction, Interactive design, UI & UX</div>
            </div>
          </div>
